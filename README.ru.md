...
5. Роутер перезагрузится, обнаружит флешку и установит Entware автоматически

### Шаг 2: Включение SWAP

После установки Entware подключитесь к роутеру по SSH для активации SWAP:
...
Чтобы swap включался автоматически после перезагрузки, создайте скрипт автозапуска:
